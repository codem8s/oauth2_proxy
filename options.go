...
func (o *Options) Validate() error {
	...
	if o.OIDCIssuerURL != "" {
		...
		if o.Scope == "" && o.OIDCAllowedGroupsPattern == "" {
			o.Scope = "openid email profile"
		} else if o.Scope == "" && o.OIDCAllowedGroupsPattern != "" {
			o.Scope = "openid email profile groups"
		}

		if o.OIDCAllowedGroupsPattern != "" && !strings.Contains(o.Scope, "groups") {
			msgs = append(msgs, "'groups' missing in scope parameter when oidc-allowed-groups-pattern is set")
		}
	}
...
func parseProviderInfo(o *Options, msgs []string) []string {
	...
	case *providers.OIDCProvider:
		...
		p.OIDCAllowedGroupsRegexp = compiledRegexp
	}
	return msgs
}
